    ...
    <form action="include/insertCase.php" method="post" name="addForm">        
        <div id="typeOfCaseHolder">
            ...
            <div id="typeOfCase_ck">
                <select id="ascallback" tabindex="1" name="ascallback">
        ...
        <div id="impactHolder">
            ...
            <div id="impact_select">
                <select id="severitylst" name="severitylst" tabindex="2">
        ...
        <div id="SAIDHolder">
            <div id="SAID_lb">SAID #</div>
            <div id="SAIDNum_tb">
                <input name="SAIDtxt" tabindex="5" type="text" size="12" maxlength="12" />
            </div>            
        </div>
        <div id="caseNumHolder">
            <div id="caseNum_lb">Case #</div>
            <div id="caseNum_tb">
                <input name="casetxt" tabindex="6" type="text" size="10" maxlength="10" />
            </div>
        ...
        <div id="searchCaseHistory_lb" tabindex="10" onclick="history('include/caseHistory.php', document.addForm.casetxt.value);" class="genericTertiaryButtonSlim">
